...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"device=sd\0" \
	"partition=0:1\0" \
	"gosd=run loadenv; run loadaudio; run loadfdt; run loadkernel; run bootsd\0" \
	"loadaudio=fatload ${device} ${partition} ${audio_loadaddr} ${audio}\0" \
...
#define CONFIG_GZIP_KERNEL_MAX_LEN		0x186A0000	/* Set MAX size to 25M after decompressed*/
...
#define CONFIG_LZO
	...
	#define CONFIG_ETHADDR			e8:72:55:98:06:14 /* random generated */
	#define CONFIG_IPADDR			172.16.20.120
	#define CONFIG_GATEWAYIP		172.16.20.1
	#define CONFIG_SERVERIP			172.16.20.220
